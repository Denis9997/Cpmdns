...
def banner(console):
    ...
    console.print("==================================================")
    console.print("[bold yellow]! Note[/bold yellow]: Logout from CUR before using this tool !.", end="\n\n")
        ...
        while True:
            ...
            if service == 0: # Exit
                ...
                if cpm.unlimited_fuel():
                    ...
                    sleep(2)
                    continue
            elif service == 16: # Change Races Wins
                ...
                if cpm.set_player_wins(amount):
                    ...
                    sleep(2)
                    continue
            elif service == 17: # Change Races Loses
